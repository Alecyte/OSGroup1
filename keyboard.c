...
volatile KEYCODE current_key;	// key code of the current key
volatile bool shift_on;		// is the SHIFT key in pressed state?
volatile bool capslock_on;	// is the CAPS LOCK key on?
